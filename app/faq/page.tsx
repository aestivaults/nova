"use client";
import { ArrowRight, HelpCircle, Minus, Plus, Search, Zap } from "lucide-react";
  ...
  return (
    <div className="min-h-screen relative overflow-hidden pt-20 md:pt-0">
      ...
      <main className="container mx-auto">
        <div className="px-2 py-4 sm:px-4 sm:py-8 lg:py-16 relative z-10">
          <section className="text-center mb-4 sm:mb-6 relative">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 backdrop-blur-sm text-purple-300 text-xs font-mono font-semibold mb-4 sm:mb-8 tracking-wider">
              <Zap className="w-3 h-3" />
              AUREUSNOVA FAQ v2.0
            </div>
            <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-black mb-3 sm:mb-6 bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent leading-tight">
              NFT FAQ Hub
              <span className="block text-xl sm:text-3xl md:text-4xl font-mono text-white/80">
                Smart Contract Ready
              </span>
            </h1>
            <p className="text-lg sm:text-2xl max-w-xl sm:max-w-3xl mx-auto mb-6 sm:mb-10 leading-relaxed text-gray-300 font-light">
            ...
            {/* Search */}
            <div className="max-w-md sm:max-w-lg mx-auto relative mb-6 sm:mb-10 group">
              ...
              <input
                ...
                className="w-full pl-16 pr-6 py-3 sm:py-4 rounded-2xl border-2 border-purple-500/20 bg-black/50 backdrop-blur-xl text-white placeholder-gray-400 focus:border-cyan-500/50 focus:ring-4 focus:ring-cyan-500/20 focus:ring-offset-2 focus:ring-offset-black transition-all duration-300 text-base font-mono tracking-wide shadow-2xl"
              />
            ...
            {filteredFAQs.length > 0 ? (
                  ...
                  >
                    <div className="bg-black/80 backdrop-blur-xl rounded-2xl overflow-hidden border border-gray-800/50">
                      <div className="p-4 sm:p-6 lg:p-10">
                        {/* Category Header */}
                        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 mb-6 relative">
                          <div className="flex items-center gap-4 flex-shrink-0">
                            <div
                              className={`relative p-2 sm:p-4 rounded-2xl flex-shrink-0 bg-gradient-to-br ${
                                category.color === "primary"
                            ...
                            return (
                              ...
                              >
                                ...
                                <button
                                  ...
                                  className="w-full flex items-center justify-between p-3 sm:p-5 text-left transition-all duration-300 hover:bg-gradient-to-r hover:from-purple-500/5 hover:to-pink-500/5"
                                >
                                  ...
                                  <div className="flex items-center gap-3 p-2 rounded-xl bg-black/50 group-hover/faq:bg-gray-800/50 backdrop-blur-sm transition-all duration-200 border border-gray-700/50">
                                    <div
                                ...
                                >
                                  <div className="px-4 sm:px-5 pb-4 sm:pb-5 border-t border-gray-700/30 bg-black/20 backdrop-blur-sm">
              ...
              <div className="text-center py-16 sm:py-20 relative">
                ...
                <div className="relative">
                  <div className="inline-flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/20 mb-4 sm:mb-6 mx-auto shadow-purple-glow">
                    <HelpCircle className="w-7 h-7 sm:w-10 sm:h-10 text-purple-400" />
                  </div>
                  <h3 className="text-2xl sm:text-3xl font-black text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-400 mb-3 sm:mb-4">
                    No Results Found
                  </h3>
                  <p className="text-gray-400 mb-6 sm:mb-8 max-w-md sm:max-w-lg mx-auto leading-relaxed">
                    Your query returned no results. Try searching for different
                    blockchain terms or browse all categories.
                  </p>
                  <button
                    onClick={() => setSearchTerm("")}
                    className="group inline-flex items-center gap-3 px-6 py-3 sm:px-8 sm:py-4 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold hover:from-purple-600 hover:to-pink-600 transition-all duration-300 shadow-2xl hover:shadow-purple-glow transform hover:-translate-y-1 font-mono tracking-wide"
                  >
                    Reset Search
