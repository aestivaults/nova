    ...
    <div className="min-h-screen relative overflow-hidden pt-20 md:pt-0">
      ...
      <main className="container mx-auto px-4 py-8 sm:py-12 lg:py-16 relative z-10">
        <section className="text-center mb-6 md:mb-12">
          <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full border border-blue-500/40 backdrop-blur-md text-blue-200 text-sm font-mono font-bold mb-8 tracking-wide shadow-lg">
            <Mail className="w-4 h-4" />
            AUREUSNOVA Contact v3.0
          </div>
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-extrabold mb-6 bg-clip-text text-transparent leading-none">
            Connect With Us
            <span className="block text-2xl sm:text-4xl md:text-5xl font-mono text-blue-100/70 mt-2">
              Support
            </span>
          </h1>
          <p className="text-lg sm:text-2xl max-w-4xl mx-auto md:mb-12 leading-relaxed text-blue-100/80 font-light tracking-wide">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          <div className="p-3 md:p-6 rounded-2xl bg-black/50 backdrop-blur-xl border border-blue-500/30 transition-all hover:shadow-blue-glow">
          ...
          <div className="p-3 md:p-6 rounded-2xl bg-black/50 backdrop-blur-xl border border-purple-500/30 transition-all hover:shadow-purple-glow">
            ...
            <a
              ...
              className="block text-center hover:text-purple-100 font-mono"
            >
              legal@aureusnova.com
            </a>
          </div>
          <div className="p-3 md:p-6 rounded-2xl bg-black/50 backdrop-blur-xl border border-indigo-500/30 transition-all hover:shadow-indigo-glow">
        ...
        <div className="relative mb-16">
          <div className="glass-card md:p-8 sm:p-6 p-3">
