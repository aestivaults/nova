...
// Define types for Team Member and Section
...
// Updated data with crypto industry standards and futuristic theme
const aboutSections: AboutSection[] = [
  {
    ...
    color: "primary",
    content:
      "In the year 2025, AUREUSNOVA is pioneering the next era of decentralized digital ownership. We empower creators and collectors with quantum-secure, AI-enhanced NFT protocols that transcend traditional blockchain limitations, fostering a multiverse of interoperable digital assets.",
  },
  {
    id: "vision",
    title: "Our Vision",
...
const teamMembers: TeamMember[] = [
  {
    id: "team1",
    name: "Alex Nova",
    role: "Quantum Founder & CEO",
    bio: "A blockchain visionary with expertise in post-quantum cryptography, Alex is architecting the fusion of AI and NFTs for a decentralized future.",
  },
  {
    id: "team2",
    name: "Samantha Ether",
  ...
  },
  {
    ...
    bio: "Jordan orchestrates quantum-secure communities, bridging real-world assets with virtual economies in the expanding Web3 multiverse.",
  },
];
        ...
        <div className="px-4 py-8 sm:py-12 lg:py-16 relative z-10">
          <section className="text-center mb-6 relative">
            ...
            <p className="text-xl sm:text-2xl max-w-3xl mx-auto mb-10 sm:mb-12 leading-relaxed text-gray-300 font-light">
              Pioneering the quantum-secure NFT revolution in Web3.
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-purple-400">
                {" "}
                AI-optimized. Multiverse ready.
              </span>
            </p>
          </section>
            ...
            <div className="relative glass-card rounded-3xl overflow-hidden border border-purple-500/20 backdrop-blur-sm">
              <div className="p-8 sm:p-10 lg:p-12 bg-gradient-to-br from-black/80 via-gray-900/80 to-black/80 backdrop-blur-xl border border-gray-800/50">
                <div className="text-center relative">
                  ...
                  <p className="text-gray-300 mb-8 sm:mb-10 leading-relaxed text-lg max-w-2xl mx-auto font-light">
                    Join the quantum NFT revolution. Connect your neural wallet
                    and transcend into the future of digital ownership.
                  </p>
